...
handlers.index = function (data, callback) {
    ...
    if (data.method == 'get') {
        // Prepare date for interpolation
        const templateData = {
            'head.title': 'Monitoring App',
            'head.description': 'A state service application for monitoring web services and sites',
            'body.class': 'index'
        };
                                    ...
                                    _data.delete('checks', checkId, function (err) {
                                        ...
                                        if (checksDeleted == checksToDelete) {
                                            if (!deletionErrors) {
                                                ...
                                                callback(500, {'Error': 'Errors encountered while attempting to delete all of the user\'s checks, all checks may not have been deleted successfully'});
                                            }
                                        }
                                    })
                                });
